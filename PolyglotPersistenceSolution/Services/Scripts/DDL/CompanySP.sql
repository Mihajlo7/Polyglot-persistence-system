...
BEGIN
	...
	INSERT INTO Companies (id,dunsNumber,name,telephone,country) VALUES(@CompanyId,@DunsNumber,@Name,@Telephone,@Country);

	INSERT INTO Sellers(id,address,city,hasShop) VALUES (@CompanyId,@Address,@City,@HasShop);
END;
...
BEGIN
	...
	INSERT INTO Couriers (id,deliveryPrice) VALUES (@CompanyId,@DeliveryPrice)
END;
